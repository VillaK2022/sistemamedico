...
<form action="/pacientes/{{ $paciente->id }}" method="POST">
    ...
    <div class="mb-3">
        ...
        <input type="number" id="cedula_paciente" name="cedula_paciente" class="form-control" value="{{ $paciente->cedula_paciente }}">
    </div>

    <div class="mb-3">
        <label for="" class="form-label">Telefono</label>
        <input type="number" id="tlf_paciente" name="tlf_paciente" class="form-control" value="{{ $paciente->tlf_paciente }}">
    </div>

    <div class="mb-3">
        <label for="" class="form-label">Ocupacion</label>
        <input type="text" id="ocupacion_paciente" name="ocupacion_paciente" class="form-control" value="{{ $paciente->ocupacion_paciente }}">
    </div>

    <div class="mb-3">
        <label for="" class="form-label">Lugar donde vive</label>
        <input type="text" id="resid_paciente" name="resid_paciente" class="form-control" value="{{ $paciente->resid_paciente }}">
    </div>
